...
impl Into<nv_video_codec_sys::cudaVideoCodec> for CudaVideoCodec {
    fn into(self) -> nv_video_codec_sys::cudaVideoCodec {
        match self {
            ...
            CudaVideoCodec::H264SVC => nv_video_codec_sys::cudaVideoCodec_enum::cudaVideoCodec_H264_SVC,
            CudaVideoCodec::H264MVC => nv_video_codec_sys::cudaVideoCodec_enum::cudaVideoCodec_H264_MVC,
            ...
            CudaVideoCodec::YUV420 => nv_video_codec_sys::cudaVideoCodec_enum::cudaVideoCodec_YUV420,
